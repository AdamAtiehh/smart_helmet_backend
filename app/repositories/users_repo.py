...
async def upsert_by_firebase_uid(
    ...
    *,
    ...
    Safe under concurrency (handles unique constraint races).
    """
    ...
    # Existing user: update only if values are provided and changed
    needs_update = False
    ...
    if needs_update:
        ...
        try:
            ...
            # e.g. email unique collision or other race; don't break profile fetch
            await db.rollback()
